...
export default class RagFusionBot extends Bot {
  static _brandId = "RagFusion"; // Brand id of the bot, should be unique. Used in i18n.
  static _className = "RagFusionBot"; // Class name of the bot
  ...
  async _sendPrompt(prompt, onUpdateResponse, callbackParam) {
    return new Promise((resolve, reject) => {
      (async () => {
        try {
          await axios
            .post("http://127.0.0.1:9000/rag_fusion/invoke", {
              input: {
                question: prompt,
              },
              config: {},
